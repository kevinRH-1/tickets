...
{{-- <script>
        ...
        $.ajax({
            ...
            success: function(data) {
               ...
               // $("#modalModificarpc").modal("show");
                $("form #modalModificar" +type +" #marca").val(datos.marca);
                $("form #modalModificar" +type +" #modelo").val(datos.modelo);
                $("form #modalModificar" +type +" #codigo").val(datos.codigo);
                $("form #modalModificar" +type +" #procesador").val(datos.procesador);
                $("form #modalModificar" +type +" #ram").val(datos.ram);
                $("form #modalModificar" +type +" #HDD").val(datos.almacenamiento);
                $("form #modalModificar" +type +" #tamano").val(datos.tamano);
                $("form #modalModificar" +type +" #descripcion").val(datos.descripcion);
                $("form #modalModificar" +type +" #lugar").val(datos.lugar_id);
                $("form #modalModificar" +type +" #categoria").val(datos.categoria_id);
                $("form #modalModificar" +type +" #estado").val(datos.estado_id);
                $("form #modalModificar" +type +" #idact").val(datos.id);
  ...
  document.querySelectorAll('[name="anadir"]').forEach(button => {
    button.addEventListener('click', function(event) {
      ...
      console.log(type);
      var id = $("form #modalModificar"+type+" #idact").val();
      var codigo = $("form #modalModificar"+type+" #codigo").val();
      var marca = $("form #modalModificar"+type+" #marca").val();
      var descripcion = $("form #modalModificar"+type+" #descripcion").val();
      console.log(marca);
      $("#modalModificar"+type).modal("hide");
      ...
      $("form #modalasignar #tipo").text(type);
