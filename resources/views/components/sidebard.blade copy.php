...
<div id="content" class="flex-1 h-full bg-white p-8 transition-all lg:ml-64">
    <div class=" border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-12">    
        @yield('content')
    </div>
</div>
...
<script>
    ...
    toggleSidebar.addEventListener('click', () => {
        // Verifica si el sidebar está abierto o cerrado
        const isOpen = sidebar.classList.contains('-translate-x-full');

        // Alterna la posición del sidebar
        if (isOpen) {
