...
<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-label for="number" value="{{ __('Numero telefonico') }}" />
            ...
            <div>
                ...
                <x-input id="roleid" class="block mt-1 w-full" type="text" name="roleid" :value="old('roleid')" required autofocus autocomplete="role" />
            </div>
